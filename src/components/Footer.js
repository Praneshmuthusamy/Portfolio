        ...
        <div class="container">
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top mb-0">
                ...
                <ul class="nav col-md-4 justify-content-end">
                    <li class="nav-item">
                        <a href="#home" class="nav-link px-2 fo1 ">Home</a>
                    </li>
                    <li class="nav-item">
                        <a href="#aboutme" class="nav-link px-2 fo1">About</a>
                    </li>
                    <li class="nav-item">
                        <a href="#projects" class="nav-link px-2 fo1">Projects</a>
                    </li>
                    <li class="nav-item">
                        <a href="#contacts" class="nav-link px-2 fo1">Contact</a>
                    </li>
                </ul>
